...
return array(
	...
	*/
	...
	/*
	|------------------------------------------------------
	| Vinventory custom validation messages
	|------------------------------------------------------
	|
	| Here you may specify custom validation messages for a
	| convention "attribute_rule" to name the lines. This h
	| custom validation clean and tidy.
	|
	| So, say you want to use a custom validation message w
	| the "email" attribute is unique. Just add "email_uniq
	| with your custom message. The Validator will handle t
	|
	*/
	'cat_unique'  	  => 'A kategória nem létezik.',
	'code_unique' 	  => 'A kód már létezik.',
	'code_exists' 	  => 'A kód nem létezik.',
	'in_stock'    	  => 'Nincs elegendő tétel raktáron.',
	'language_exists' => 'Ez a nyelv nem támogatott.',
	'role_is_admin'   => 'Nincs jogosultságod felhasználótípust váltani.',
