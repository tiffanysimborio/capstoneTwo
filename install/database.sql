...
-- Dumping structure for table theinventory.categories
...
-- Dumping data for table theinventory.categories: ~0 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;


-- Dumping structure for table theinventory.contacts
...
-- Dumping data for table theinventory.contacts: ~0 rows (approximately)
/*!40000 ALTER TABLE `contacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `contacts` ENABLE KEYS */;


-- Dumping structure for table theinventory.items
...
-- Dumping data for table theinventory.items: ~0 rows (approximately)
/*!40000 ALTER TABLE `items` DISABLE KEYS */;
/*!40000 ALTER TABLE `items` ENABLE KEYS */;


-- Dumping structure for table theinventory.log
...
-- Dumping data for table theinventory.log: ~0 rows (approximately)
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
/*!40000 ALTER TABLE `log` ENABLE KEYS */;


-- Dumping structure for table theinventory.permissions
...
-- Dumping data for table theinventory.permissions: ~31 rows (approximately)
...
-- Dumping structure for table theinventory.permission_role
...
-- Dumping data for table theinventory.permission_role: ~86 rows (approximately)
...
-- Dumping structure for table theinventory.roles
...
-- Dumping data for table theinventory.roles: ~6 rows (approximately)
...
-- Dumping structure for table theinventory.role_user
...
-- Dumping data for table theinventory.role_user: ~1 rows (approximately)
...
-- Dumping structure for table theinventory.sessions
...
-- Dumping data for table theinventory.sessions: 1 rows
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`id`, `last_activity`, `data`) VALUES
	('jvzZtOho4G5XO1QoygwIjkMQJxG4cv1RbUNeOCC0', 1364252112, 'a:4:{s:5:":new:";a:0:{}s:5:":old:";a:0:{}s:10:"csrf_token";s:40:"AuYPZqFW82WJ7itputALrPKBfIg2osvMSWTUgFRR";s:12:"verify_login";i:1;}');
/*!40000 ALTER TABLE `sessions` ENABLE KEYS */;


-- Dumping structure for table theinventory.settings
...
-- Dumping data for table theinventory.settings: ~1 rows (approximately)
...
-- Dumping structure for table theinventory.transactions
...
-- Dumping data for table theinventory.transactions: ~0 rows (approximately)
/*!40000 ALTER TABLE `transactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `transactions` ENABLE KEYS */;


-- Dumping structure for table theinventory.transaction_types
...
-- Dumping data for table theinventory.transaction_types: ~2 rows (approximately)
...
-- Dumping structure for table theinventory.users
...
-- Dumping data for table theinventory.users: ~1 rows (approximately)
